 ...
 const words = ['Sherlock', 'NancyDrew', 'Feluda', 'HardyBoys', 'Tintin', 'MissMarpel', 'ScoobyDoo', 'DirkGently', 'HarryPotter', 'AgathaChristie','PhilipMarlowe','EnidBlyton','SamSpade','ByomkeshBokshi','Columbo','PerryMason','RobertLangdon','DetectiveMangloo','AlexCross','Cadfael','VeronicaMars','HerculePoirot','InvisibleMan','PeterPan','SherlockHolmes','EnidBlyton','DanBrown'];
